...
namespace Plugins.Event_System_SO.DEMO.Scripts
{
    public class UIManager : MonoBehaviour
    {
        ...
        [SerializeField] private IntGameEventSO intGameEvent;
        [SerializeField] private FloatGameEventSO floatGameEvent;
        [SerializeField] private BoolGameEventSO boolGameEvent;
        [SerializeField] private StringGameEventSO stringGameEvent;

        // UI Elements.
        [Header("UI Text")] [SerializeField] private TextMeshProUGUI demoText;
